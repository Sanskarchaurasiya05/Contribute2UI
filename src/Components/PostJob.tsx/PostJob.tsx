    ...
    return <div className="w-4/5 mx-auto">
        <div className="text-2xl font-semibold"></div>
            ...
            <div className="flex gap-4">
                 <Button onClick={handlePost}  color="brightSun.4" variant="light" fullWidth>Publish Job</Button>
                  <Button  color="brightSun.4" variant="outline" fullWidth>save as Draft</Button>
            </div>
        </div>
    </div>
